...
_Language and the Computer_ was a peculiar module. It was taught in a department whose students weren’t normally expected to think algorithmically. Most of us had never even programmed a computer before, with two exceptions: a final-year computer science major who’d enrolled for a free A (understandable, since my university graded on a curve), and a fellow third-year whose dad sent him to C classes when he was a teenager.
...
Alas, I couldn’t find it in my hard drive, even though my other bachelor’s module materials were there. The code must have been stored on a USB stick, since I remember using the university computers to work on my project. It has most certainly long been misplaced by now. We can add an inability to back up my code as one of my early failings back then, too.
