...
_Language and the Computer_ was a peculiar module. It was taught in the linguistics department, whose students weren’t normally expected to think algorithmically. All of us had never even programmed a computer before, with two exceptions: a final-year computer science major who’d enrolled for a free A (understandable, since my university graded on a curve), and a fellow third-year whose dad sent him to C classes when he was a teenager.
...
Alas, I couldn’t find it in my hard drive, even though materials from other modules were there. The code must have been stored on a USB stick, since I remember using the university computers to work on my project. It has most certainly been misplaced by now. We can add an inability to back up my code as one of my early failings, too.

If it weren’t for that fourth-year CS student who kindly helped me, I would have failed the module. He was Vietnamese and had a younger brother whom he banned from using the calculator while the latter was learning maths at school. He once told me his dad fought in the Vietnam War on the side of the North Vietnamese army (could’ve also been the Vietcong). When I heard that, I recalled that one scene from _Top Gear_’s Vietnam special, where Jeremy Clarkson spoke to an older Vietnamese man who was writing in the sand to describe his experience as a combatant in the war. (I don’t know how I remember these random facts but couldn’t manage to back up my bloody work.)

By the end of the semester, I had got to know three fellow classmates quite well. Unlike me, all were linguistics majors. One of them was the one whose dad made him learn C. As we finished the first draft of our final project and ran our code on the corpus, one thing became painfully clear: it was _slow_. This was partly because Python itself was rather slow at the time, and mostly because we’d simply written highly inefficient programs.
